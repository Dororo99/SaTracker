...
Camera BEV and Satellite BEV are trained INDEPENDENTLY, each with their own
segmentation head. No fusion at this stage.

- Camera: BEVFormer → cam_bev → cam_seg_head → seg_loss
- Satellite: SatelliteEncoder → sat_bev → sat_seg_head → seg_loss
"""
...
model = dict(
    ...
    # ── Satellite branch (Stage 1: independent) ──
    use_sat_fusion=False,       # No fusion at Stage 1
